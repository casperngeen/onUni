  ...
  if (nextTest) {
    return (
      <div className='suggested-test-container'>
        <div className='suggested-test-header'>
          Recommended activity
        </div>
        <div className='suggested-test-description-container'>
          {nextTest.testType === TestTypes.EXAM
                ? <Image className='suggested-test-image' src='/next-exam.svg' alt='test' />
                : <Image className='suggested-test-image' src='/next-test.svg' alt='test' />
              }
          <div className='suggested-test-info'>
            <div className='suggested-test-title-container'>
              ...
              <div className='suggested-test-title'>
                {nextTest.testTitle}
              </div>
              <div className='suggested-test-type'>
                ...
                {nextTest.testType === TestTypes.EXAM
                  ? <div className='suggested-test-type-text'>
                    Exam
                  </div>
            ...
            <UniButton custombutton='confirm' style={{width: '240px'}} onClick={viewNextTest}>Continue</UniButton>
          </div>
        </div>
      </div>
    )
