...
const SideBarButtons: React.FC<{}> = () => {
  ...
  return isSummary ? (
    <div className="sidebar-buttons">
      {isQuiz && (
        <UniButton custombutton="confirm" onClick={reAttempt}>
          Re-attempt
        </UniButton>
      )}
      <UniButton custombutton="exit" onClick={leavePage}>
        Exit
      </UniButton>
    </div>
  ) : (
    <div className="sidebar-buttons">
      <UniButton custombutton="confirm" onClick={openSubmit}>
        Submit
      </UniButton>
      {isQuiz && (
        <UniButton custombutton="exit" onClick={openExit}>
          Exit
        </UniButton>
      )}
    </div>
