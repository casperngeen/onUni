    ...
    <div className="quiz-content">
      <div className="quiz-info">
        <div className="info-title">
          <div className="quiz-test-title">{testTitle}</div>
          <div className="test-questions">{maxScore} questions</div>
        </div>
        <div className="quiz-test-description">{testDescription}</div>
        <div>
          <Image
            src="/online-learning 1.svg"
            className="quiz-image"
            alt="online-learning-1"
          />
        </div>
      </div>
