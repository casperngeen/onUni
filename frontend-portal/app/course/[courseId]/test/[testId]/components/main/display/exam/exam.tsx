        ...
        <div className="other-info-exam">
          <div className="info-row-exam">
            <div className="panel-item-exam">
              <div className="panel-title-exam">No. of attempts:</div>
              <div className="panel-content-exam">
                {numOfAttempts}/{maxAttempts}
              </div>
            </div>
            <div className="panel-item-exam">
              <div className="panel-title-exam">Time limit:</div>
              <div className="panel-content-exam">
          ...
          <div className="info-row-exam">
            <div className="panel-item-exam">
              <div className="panel-title-exam">Scoring format:</div>
              <div className="panel-content-exam">
                {renderScoringFormat(scoringFormat as ScoringFormats)}
              </div>
            </div>
            <div className="panel-item-exam">
              <div className="panel-title-exam">Validity period:</div>
              <div className="panel-content-exam">
                {startDate} - <br />
                {endDate}
              </div>
