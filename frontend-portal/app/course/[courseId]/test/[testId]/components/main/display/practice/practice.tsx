...
const PracticeContentPage: React.FC<{}> = () => {
  ...
  const attempts = selector(selectAttemptHistory).filter(
    ...
    <div className="practice-content">
      <div className="info-panel-practice">
        <div className="score-panel-practice">
          <div className="score-description-practice">Highest score:</div>
        ...
        <div className="other-info-practice">
          <div className="panel-item-practice">
            <div className="panel-title-practice">Time limit:</div>
            <div className="panel-content-practice">
              {timeLimit === 1 ? `1 minute` : `${timeLimit} minutes`}
            </div>
          </div>
          <div className="panel-item-practice">
            <div className="panel-title-practice">Attempts allowed:</div>
            <div className="panel-content-practice">Unlimited</div>
          </div>
        </div>
      </div>
      <div className="instructions">
        <div className="instruction-title">Note:</div>
        <div className="instruction-info">
          <ul>
            <li>Keep a stable connection throughout the test</li>
            <li>
              The system will automatically record the results if you exit
              during the test
            </li>
