...
import { IDeleteTest, IGetAllTests, IGetTest, INewTest, ISingleTestResponse, IAllTestResponse, IUpdateTest, ITestResponse } from "./types/test.types";
import BaseRequest from "./base.request";

export default class TestRequest extends BaseRequest {
    public static async getAllTests(params: IGetAllTests) {
        const { courseId } = params;
        return await BaseRequest.request<IAllTestResponse[]>(`course/${courseId}/tests`, RequestTypes.GET, {});
    }
