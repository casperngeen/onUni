import { AttemptResponse, IAllAttempts, IDeleteAttempt, IGetAttempt, INewAttempt, IQuestionAttemptInfo, ISaveAttempt, ISaveQuestionAttempt, ITestInfoForAttemptResponse, NewAttemptResponse } from "./types/attempt.types";
