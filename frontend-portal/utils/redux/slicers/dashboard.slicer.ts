...
const dashboardSlice = createAppSlice({
    ...
    reducers: (create) => ({
        ...
        fetchAllCourses: create.asyncThunk.withTypes<{rejectValue: {message: string, errorCode: number}}>()(
...
export const { selectActiveCourses, selectInactiveCourses, selectLoading,
    selectErrorCode, selectErrorMessage, selectNextTest } = dashboardSlice.selectors;
